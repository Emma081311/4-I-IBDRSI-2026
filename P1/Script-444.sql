...
create database Emmanuel;
USE Emmanuel;

CREATE TABLE `Emmanuel`.`BOOKS` (
...
DROP TABLE Emmanuel.BOOKS;

CREATE TABLE `Emmanuel`.`CATEGORIES` (
ID INT NOT NULL auto_increment PRIMARY KEY,
 NAME VARCHAR(50) NOT NULL,
 CATEGORYid varchar(50)
 );

DROP TABLE Emmanuel.CATEGORIES;

CREATE TABLE `Emmanuel`.`AUTHORS` (
ID INT not null auto_increment PRIMARY KEY,
 NAME VARCHAR(50) NOT NULL,
 AUTHORSid varchar(50)
 );
 
 DROP TABLE Emmanuel.AUTHORS;

INSERT INTO
	`Emmanuel`.`CATEGORIES`(CATEGORYID,NAME)
VALUES
	(1, 'Cat-A'),
	(2, 'Cat-B'),
	(3, 'Cat-C'),
